    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-background relative overflow-hidden">
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="text-center mb-8">
                                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20">
                                    ...
                                    <span className="text-xs font-bold text-accent uppercase tracking-wider">Enterprise AI Innovation</span>
                                </div>
                            </div>

                            {/* Main Heading */}
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-center text-primary mb-6 leading-tight">
                                Agentic AI Solutions<br />
                                <span className="text-transparent bg-clip-text bg-brand-gradient">Development</span>
                            </h1>

                            {/* Subheading */}
                            <p className="text-xl md:text-2xl text-center text-secondary max-w-4xl mx-auto mb-8 leading-relaxed">
                                Building intelligent systems that think, decide, and act.
                            </p>

                            {/* Description */}
                            <p className="text-lg text-center text-secondary max-w-3xl mx-auto mb-12 leading-relaxed">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                                ...
                                >
                                    <MessageSquare className="w-5 h-5" /> Start Your AI Journey
                                </button>
                ...
                {/* Core Capabilities */}
                <section id="capabilities" className="py-20 bg-surface border-y border-border">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-black text-primary mb-4">Core Capabilities</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                            {[
                                ...
                                <div key={index} className="glass-card p-8 rounded-2xl hover:-translate-y-2 transition-all duration-300 bg-background border border-border">
                                    ...
                                    <p className="text-secondary leading-relaxed">{capability.description}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section id="solutions" className="py-20 bg-background">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-black text-primary mb-4">What We Build</h2>
                            <p className="text-lg text-secondary max-w-2xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
                            {[
                                ...
                                <div key={index} className="glass-card p-8 rounded-2xl bg-surface border border-border hover:border-accent/30 transition-all">
                ...
                {/* Why Choose Us */}
                <section id="why-us" className="py-20 bg-surface border-y border-border">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-black text-primary mb-4">Why Choose Us</h2>
                            <p className="text-lg text-secondary max-w-2xl mx-auto">
                ...
                <section id="approach" className="py-20 bg-background">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-black text-primary mb-4">Our Approach</h2>
                            <p className="text-lg text-secondary max-w-2xl mx-auto">
                            ...
                            {[
                                ...
                                <div key={index} className="flex gap-6 mb-8 group">
                                    <div className="flex flex-col items-center">
                                        <div className="w-16 h-16 rounded-xl bg-accent/10 flex items-center justify-center border-2 border-accent/20 group-hover:border-accent transition-colors flex-shrink-0">
                                            <span className="text-xl font-black text-accent">{phase.step}</span>
                                        </div>
                                        {index < 5 && (
                                    ...
                                    <div className="flex-1 pb-8">
                                        ...
                                        <p className="text-secondary leading-relaxed">{phase.description}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                <section className="py-20 bg-surface border-y border-border">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-black text-primary mb-4">Technology Stack</h2>
                            <p className="text-lg text-secondary max-w-2xl mx-auto">
                        ...
                        <div className="max-w-5xl mx-auto">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                {['OpenAI', 'Anthropic', 'Google Gemini', 'Meta Llama', 'LangChain', 'LangGraph', 'AutoGen', 'CrewAI', 'Azure AI', 'AWS Bedrock', 'Hugging Face', 'Pinecone'].map((tech, index) => (
                                    <div key={index} className="glass-card p-6 rounded-xl text-center bg-background border border-border hover:border-accent/30 transition-all hover:-translate-y-1">
                                        <div className="text-lg font-bold text-primary">{tech}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 mb-12">
                                <div className="glass-card p-6 rounded-2xl bg-surface border border-border text-center hover:border-accent/30 transition-all">
                                    <div className="w-14 h-14 rounded-xl bg-accent/10 flex items-center justify-center mx-auto mb-4">
                                        <Phone className="w-7 h-7 text-accent" />
                                    </div>
                                    <h3 className="font-bold text-primary mb-2">Call Us</h3>
                                    <a href="tel:+919701087446" className="text-accent hover:text-accent-hover font-medium">
                                        +91-9701087446
                                    </a>
                                    <p className="text-xs text-muted mt-2">Mon-Fri, 9 AM - 6 PM IST</p>
                                </div>
                                ...
                                <div className="glass-card p-6 rounded-2xl bg-surface border border-border text-center hover:border-accent/30 transition-all">
                                    ...
                                    <a href="mailto:info@swazsolutions.com" className="text-accent hover:text-accent-hover font-medium break-all">
                                        info@swazsolutions.com
                                    </a>
                                    <p className="text-xs text-muted mt-2">Response within 24 hours</p>
                                </div>
                                ...
                                <div className="glass-card p-6 rounded-2xl bg-surface border border-border text-center hover:border-accent/30 transition-all">
                                    ...
                                    <h3 className="font-bold text-primary mb-2">Free Consultation</h3>
                                    <p className="text-secondary text-sm">
                                        NDA-protected strategy session
                                    </p>
                                    <p className="text-xs text-muted mt-2">30-minute discovery call</p>
                                </div>
                            </div>

                            {/* Contact Form */}
                            <UnifiedContactForm defaultType="agentic-ai" />
